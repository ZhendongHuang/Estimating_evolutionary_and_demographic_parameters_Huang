...
simtime = 2500
priormu = [0.25*10**(-8), 0.5*10**(-8)]
prioreps = [0, 0]
accept_threshold = [1000,400]



demo_model = msprime.Demography.isolated_model([pop_size], growth_rate=[10**(-3)])
...
byrun = 1
name1 = "mud4_musimall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_noeps=" +"_noconver_expne_efibd.dat"
name3 = "mud4_sta1simall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_noeps(est)=" +"_noconver_expne_efibd.dat"
name5 = "mud4_sta1inf_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_noeps(est)=" +"_noconver_expne_efibd.dat"
