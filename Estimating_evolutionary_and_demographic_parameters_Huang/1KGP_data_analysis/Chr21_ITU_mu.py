...
for i in range(len(sam.individuals_population)):
    if sam.individuals_population[i]==25:
        ITUlist.append(i)
newdata = sam.subset(individuals=ITUlist)
...
inipopsize =[45137, 20200, 9040, 3500, 2700, 3080,3850,4600,  6000 , 8000, 10000,26000,26500,21200,17300]
genuse = []
inipuse = []
gruse = []
...
byrun = 1
name1 = "chr21_arealmusimall_"+"run="+str(byrun) +"ITU_efibd.dat"
name3 = "chr21_arealsta1simall_"+"run="+str(byrun) +"ITU_efibd.dat"
name4 = "chr21_arealsta2simall_"+"run="+str(byrun) +"ITU_efibd.dat"
name5 = "chr21_arealsta1inf_"+"run="+str(byrun) +"ITU_efibd.dat"
name6 = "chr21_arealsta2inf_"+"run="+str(byrun) +"ITU_efibd.dat"
name7 = "chr21_arealabdlen_"+"run="+str(byrun) +"ITU_efibd.dat"
