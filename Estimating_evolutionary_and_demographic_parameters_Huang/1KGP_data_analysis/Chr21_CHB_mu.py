...
for i in range(len(sam.individuals_population)):
    if sam.individuals_population[i]==0:
        CHBlist.append(i)
newdata = sam.subset(individuals=CHBlist)
...
inipopsize =[96800, 22000, 5000, 1540, 2300, 2700,3500,\
              4400,  6250 , 8000, 9600,26000,26500,21200,19000]
genuse = []
inipuse = []
gruse = []
...
byrun = 1
name1 = "chr21_arealmusimall_"+"run="+str(byrun) +"CHB_efibd.dat"
name3 = "chr21_arealsta1simall_"+"run="+str(byrun) +"CHB_efibd.dat"
name4 = "chr21_arealsta2simall_"+"run="+str(byrun) +"CHB_efibd.dat"
name5 = "chr21_arealsta1inf_"+"run="+str(byrun) +"CHB_efibd.dat"
name6 = "chr21_arealsta2inf_"+"run="+str(byrun) +"CHB_efibd.dat"
name7 = "chr21_arealabdlen_"+"run="+str(byrun) +"CHB_efibd.dat"
