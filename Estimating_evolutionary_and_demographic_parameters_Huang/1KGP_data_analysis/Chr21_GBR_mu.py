...
for i in range(len(sam.individuals_population)):
    if sam.individuals_population[i]==8:
        GBRlist.append(i)
newdata = sam.subset(individuals=GBRlist)
...
byrun = 1
name1 = "chr21_arealmusimall_"+"run="+str(byrun) +"GBR_efibd.dat"
name3 = "chr21_arealsta1simall_"+"run="+str(byrun) +"GBR_efibd.dat"
name4 = "chr21_arealsta2simall_"+"run="+str(byrun) +"GBR_efibd.dat"
name5 = "chr21_arealsta1inf_"+"run="+str(byrun) +"GBR_efibd.dat"
name6 = "chr21_arealsta2inf_"+"run="+str(byrun) +"GBR_efibd.dat"
name7 = "chr21_arealabdlen_"+"run="+str(byrun) +"GBR_efibd.dat"
