...
inipopsize =[12500,12500,11900,11500,10600,9600,9000,9600,10600,11900,13500,28500,26900,20800]
genuse = []
inipuse = []
gruse = []
...
byrun = 1
name1 = "chr21_arealmusimall_"+"run="+str(byrun) +"MSL_efibd.dat"
name3 = "chr21_arealsta1simall_"+"run="+str(byrun) +"MSL_efibd.dat"
name4 = "chr21_arealsta2simall_"+"run="+str(byrun) +"MSL_efibd.dat"
name5 = "chr21_arealsta1inf_"+"run="+str(byrun) +"MSL_efibd.dat"
name6 = "chr21_arealsta2inf_"+"run="+str(byrun) +"MSL_efibd.dat"
name7 = "chr21_arealabdlen_"+"run="+str(byrun) +"MSL_efibd.dat"
