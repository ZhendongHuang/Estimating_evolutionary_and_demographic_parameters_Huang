...
inipopsize =[109000,35500,11500,1900,2300,2900,3500,4200,5800,7700,9600,25800,25800,21200]
genuse = []
inipuse = []
gruse = []
...
byrun = 1
name1 = "chr21_arealmusimall_"+"run="+str(byrun) +"BEB_efibd.dat"
name3 = "chr21_arealsta1simall_"+"run="+str(byrun) +"BEB_efibd.dat"
name4 = "chr21_arealsta2simall_"+"run="+str(byrun) +"BEB_efibd.dat"
name5 = "chr21_arealsta1inf_"+"run="+str(byrun) +"BEB_efibd.dat"
name6 = "chr21_arealsta2inf_"+"run="+str(byrun) +"BEB_efibd.dat"
name7 = "chr21_arealabdlen_"+"run="+str(byrun) +"BEB_efibd.dat"
