...
inipopsize =[15200, 15200, 15600, 14800, 12400, 10400,9800,10400,12000,14400,16800,29400,28000,22000,19000]
genuse = []
inipuse = []
gruse = []
...
byrun = 1
name1 = "chr21_arealmusimall_"+"run="+str(byrun) +"LWK_efibd.dat"
name3 = "chr21_arealsta1simall_"+"run="+str(byrun) +"LWK_efibd.dat"
name4 = "chr21_arealsta2simall_"+"run="+str(byrun) +"LWK_efibd.dat"
name5 = "chr21_arealsta1inf_"+"run="+str(byrun) +"LWK_efibd.dat"
name6 = "chr21_arealsta2inf_"+"run="+str(byrun) +"LWK_efibd.dat"
name7 = "chr21_arealabdlen_"+"run="+str(byrun) +"LWK_efibd.dat"
