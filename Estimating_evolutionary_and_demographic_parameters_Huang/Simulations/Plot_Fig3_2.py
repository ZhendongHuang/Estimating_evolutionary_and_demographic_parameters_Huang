...
for sam_size in [5,10,20,40,80]:
    name = "muhat_true_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "constne_len108.dat"
    file = open(name,"rb")
...
epsilon = 0.001
for sam_size in [5,10,20,40,80]:
    name = "muhat_true_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "expne0001_len108.dat"
    file = open(name,"rb")
    mulist = pickle.load(file)
    file.close()
...
epsilon = 0.001
for sam_size in [5,10,20,40,80]:
    name = "muhat_true_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "bottleneck_len108.dat"
    file = open(name,"rb")
    mulist = pickle.load(file)
    file.close()
