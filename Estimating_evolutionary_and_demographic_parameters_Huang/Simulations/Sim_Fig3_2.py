...
name1 = "muhat_true_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "bottleneck_len108.dat"
name2 = "epsilonhat_true_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "bottleneck_len108.dat"
...
file = open(name2,"wb")
pickle.dump(epsilonhatlist,file)
file.close()
