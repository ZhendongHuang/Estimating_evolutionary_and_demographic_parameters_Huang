...
name1 = "muhat_true_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "expne0001_len108.dat"
name2 = "epsilonhat_true_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "expne0001_len108.dat"
