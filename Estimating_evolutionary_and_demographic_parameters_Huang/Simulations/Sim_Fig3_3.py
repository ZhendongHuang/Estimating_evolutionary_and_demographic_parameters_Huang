...
name1 = "muhat_true_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "constne.dat"
name2 = "epsilonhat_true_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "constne.dat"
...
name = "gihatcon_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "constne.dat"
file = open(name,"wb")
pickle.dump(gihatcon,file)
file.close()

name = "gitrue_" + "eps=" + str(epsilon) + "_sam_size=" + str(sam_size) + "constne.dat"
file = open(name,"wb")
