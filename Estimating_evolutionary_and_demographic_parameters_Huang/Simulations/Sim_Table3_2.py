...
# priorpop1 = [7000,500]
# priorjump = [5000,500]
# priorpop2 = [23000,1000]
############### f 
# priorpop1 = [6000,8000]
# priorjump = [4500,6000]
# priorpop2 = [22000,25000]

######### g
priorpop1 = [5500,7500]
priorjump = [4500,6500]
priorpop2 = [23000,25000]
...
for iter in range(totaliter):
    ...
    demo_model = msprime.Demography.isolated_model([10**6], growth_rate=[0.01])
    demo_model.add_population_parameters_change(50, growth_rate=0.04, population=None)
    demo_model.add_population_parameters_change(150, growth_rate=0.003, population=None)
    demo_model.add_population_parameters_change(300, growth_rate=0, population=None)
    demo_model.add_population_parameters_change(5000,  initial_size=24000, growth_rate=0, population=None)
...
##########################################################################
    ...
    for run in range(simtime):
        ...
        pop1sim = numpy.random.uniform(priorpop1[0],priorpop1[1])       
        jumpsim = numpy.random.uniform(priorjump[0],priorjump[1])
        pop2sim = numpy.random.uniform(priorpop2[0],priorpop2[1])
        ## put a population cap = 20000*2
        
        demo_model = msprime.Demography.isolated_model([pop1sim], growth_rate=[0])
        demo_model.add_population_parameters_change(jumpsim,  initial_size=pop2sim, growth_rate=0, population=None)
...
#         if abs(summary_sta1_sim - summary_sta1_inf) < accept_threshold[0] and abs(summary_sta2_sim - summary_sta2_inf) < accept_threshold[1]:
        ...
        pop1accept.append(pop1sim)
        jumpaccept.append(jumpsim)
        pop2accept.append(pop2sim)
    ...
    pop1acceptlist= pop1acceptlist + pop1accept
    jumpacceptlist = jumpacceptlist + jumpaccept
    pop2acceptlist = pop2acceptlist + pop2accept
...
byrun = 1
name1 = "jmusimall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name2 = "jpop1simall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name3 = "jsta1simall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name4 = "jsta2simall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name5 = "jsta1inf_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name6 = "jsta2inf_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name7 = "jabdlen_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)" +"_withconver_EAne(est)_efibd.dat"
name8 = "jjumpsimall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name9 = "jpop2simall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name10 = "jsta3simall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)" +"_withconver_EAne(est)_efibd.dat"
name11 = "jsta4simall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name12 = "jsta3inf_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name13 = "jsta4inf_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
name14 = "jepssimall_seq_len="+str(seq_len)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(est)"  +"_withconver_EAne(est)_efibd.dat"
...
file = open(name2,"wb") 
pickle.dump(pop1acceptlist,file)
file.close()
...
file = open(name8,"wb") 
pickle.dump(jumpacceptlist,file)
file.close()

file = open(name9,"wb") 
pickle.dump(pop2acceptlist,file)
file.close()
