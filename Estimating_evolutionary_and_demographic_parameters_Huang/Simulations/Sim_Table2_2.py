...
byrun = 1
name1 = "hmusimall_seq_len="+str(seq_len)+"trun"+str(min_span)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(no)=" + str(epsilon)+"_noconver_constne_tiibd.dat"
name3 = "hsta1simall_seq_len="+str(seq_len)+"trun"+str(min_span)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(no)=" + str(epsilon)+"_noconver_constne_tiibd.dat"
name5 = "hsta1inf_seq_len="+str(seq_len)+"trun"+str(min_span)+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(no)=" + str(epsilon)+"_noconver_constne_tiibd.dat"
