...
name1 = "xx_true_list="+str(sam_size)+"_constne_bottleneck1_len108.dat"
name2 = "nt_true_list="+str(sam_size)+"_constne_bottleneck1_len108.dat"
...
####
    ...
    plt.xlim(0,90000)
#     plt.plot(xx, 20000*numpy.exp(-0.00001*numpy.array(xx)) )
