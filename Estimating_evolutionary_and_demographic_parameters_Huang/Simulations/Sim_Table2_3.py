...
byrun = 1
name1 = "zmusimall_seq_len="+str(seq_len)+"trun0"+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(no)=" + str(epsilon)+"_noconver_constne_ttibd.dat"
name3 = "zsta1simall_seq_len="+str(seq_len)+"trun0"+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(no)=" + str(epsilon)+"_noconver_constne_ttibd.dat"
name5 = "zsta1inf_seq_len="+str(seq_len)+"trun0"+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(no)=" + str(epsilon)+"_noconver_constne_ttibd.dat"
name7 = "zabdlen_seq_len="+str(seq_len)+"trun0"+"run="+str(byrun) +"_sam_size="+str(sam_size)+"_eps(no)=" + str(epsilon)+"_noconver_constne_ttibd.dat"
